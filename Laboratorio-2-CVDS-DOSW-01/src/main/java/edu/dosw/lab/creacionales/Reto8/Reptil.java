...
public class Reptil extends Animal {
    public Reptil(String nombre, int edad, String sonidoCaracteristico, String dieta,
    ...
    public void hacerSonido() {
        System.out.println(getNombre() + " hace un sonido de reptil: " + super.sonidoCaracteristico);
    }
}